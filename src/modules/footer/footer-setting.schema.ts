...
export const updateFooterSettingSchema = z.object({
  ...
  newsletterTitle: z.string().max(200).nullable().optional(),
  newsletterDescription: z.string().max(500).nullable().optional(),
  newsletterPlaceholder: z.string().max(120).nullable().optional(),
  newsletterButtonLabel: z.string().max(80).nullable().optional(),
  newsletterSuccessMessage: z.string().max(500).nullable().optional(),
